---
title: Introducción a Mozo
description: "Sistema integral para gestionar mesas, pedidos y comandas en restaurantes, bares y cafeterías."
slug: /mozo/introduccion
...
![Interfaz principal del sistema Mozo](img/mozo1.jpg)

<CardGroup cols={1}>
  <Card title="Credenciales de acceso a la demo">
    **URL de acceso:** https://restaurante.demo3pro6.ibu.pe
